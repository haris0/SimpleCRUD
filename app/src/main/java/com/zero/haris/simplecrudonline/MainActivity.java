...
public class MainActivity extends AppCompatActivity {
    ...
    String url_read_mhs = "https://zerosample.000webhostapp.com/api/simple_crud/read_mhs.php";
    ...
    class ReadMhsTask extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Toast.makeText(MainActivity.this, "Data Tersedia", Toast.LENGTH_LONG).show();
